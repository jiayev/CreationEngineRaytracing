...
namespace Pass::Raytracing
{
	...
	void ReSTIRGIPass::CheckBindings()
	{
		...
		bindingSetDesc.bindings = {
			...
			nvrhi::BindingSetItem::Texture_SRV(11, textureManager.GetTexture(RenderTarget::DiffuseAlbedo)),
	...
	void ReSTIRGIPass::CopyCurrentGBufferToPrevious(nvrhi::ICommandList* commandList)
	{
		...
		commandList->copyTexture(giRes->prevGBufferDepth, nvrhi::TextureSlice(), textureManager.GetTexture(RenderTarget::ClipDepth), nvrhi::TextureSlice());
